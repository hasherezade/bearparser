...
typedef enum LoadConfigNumericDefines {
    ...
    IMAGE_GUARD_CF_EXPORT_SUPPRESSION_INFO_PRESENT =0x00004000,  // Module contains suppressed export information. This also infers that the address taken
